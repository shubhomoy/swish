...
//    class CompleteRegistration extends AsyncTask<String, String, String> {
//        @Override
//        protected void onPreExecute() {
//            super.onPreExecute();
...
//            HttpPost post = new HttpPost(config.url + "insertGCM");
//            List<NameValuePair> list = new ArrayList<NameValuePair>();
//            list.add(new BasicNameValuePair("user_id", "" + prefs.getUserId()));
//            list.add(new BasicNameValuePair("reg_id", prefs.getGCMRegId()));
//            try {
...
//                getActivity().finish();
//                Intent intent = new Intent(getActivity(), TheWallActivity.class);
//                intent.putExtra("what", "pin-feed");
...
//                    @Override
//                    public void onClick(DialogInterface dialogInterface, int i) {
//                        new CompleteRegistration().execute();
//                    }
//                });
